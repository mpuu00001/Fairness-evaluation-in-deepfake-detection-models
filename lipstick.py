...
def lipstick(image, Rg=100, Gg=35, Bg=45):
    """
    Apply lipstick to a given image.
    ...
    # fill in lipstick to lip region
    ...
    image, _, shape, height, width = compute_statistics(image)
    ...
    image_copy = smoothen(image_copy, image, height, width, upper_x_points, upper_y_points)
    image_copy = smoothen(image_copy, image, height, width, lower_x_points, lower_y_points)
